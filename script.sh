...
# 0.1
python main.py --log-dir log_ppo_base14 --mode residual_train --action-bias 0.1 
python main.py --log-dir log_ppo_res_21 --mode train --residual --total-timesteps 6_000_000

python main.py --log-dir log_ppo_base14 --mode eval --action-bias 0.1 
python main.py --log-dir log_ppo_res_21 --mode eval --action-bias 0.1 

# 0.2
python main.py --log-dir log_ppo_base14 --mode residual_train --action-bias 0.2
...
# 0.3
python main.py --log-dir log_ppo_base14 --mode residual_train --action-bias 0.3
...
# 0.4
python main.py --log-dir log_ppo_base14 --mode residual_train --action-bias 0.4
...
python main.py --log-dir log_ppo_res_25-2 --mode train --residual --total-timesteps 6_000_000
python main.py --log-dir log_ppo_res_25-2 --mode eval --residual
python main.py --log-dir log_ppo_res_25-2 --mode eval --action-bias 0.5

# 0.6
python main.py --log-dir log_ppo_base15 --mode residual_train --action-bias 0.6
